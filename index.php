...
<head>
    ...
    console.log("db_queries barchart subquery:");
    console.table(<?php echo json_encode($barchartdebug4, JSON_NUMERIC_CHECK); ?>);
    console.log("db_queries barchart query old 1:");
    console.table(<?php echo json_encode($barchartold1, JSON_NUMERIC_CHECK); ?>);
